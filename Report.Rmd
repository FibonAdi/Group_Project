...
_In this graph, watch time is compared to average viewers, with the natural log taken of each variable again.  There is a larger cluster of points on the lower end of the graph (lower watch time), especially between 18 and 20 minutes.  Overall, the graph shows that a higher watch time is typically correlated with a higher count of average viewers._
